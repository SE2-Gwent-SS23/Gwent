...
//
//    public ServerHelper(Activity mActivity, Context mContext){
//        this.mActivity = mActivity;
//        this.mContext = mContext;
//        this.mConnectionsClient = Nearby.getConnectionsClient(mActivity);
//    }
//
//    /**
...
//                    ServerHelper.this.onConnectionInitiated(endpoint, connectionInfo);
//                }
//
//                @Override
...
//                                        ServerHelper.toString(result.getStatus())));
